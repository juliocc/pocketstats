...
Source: http://bugs.python.org/issue4356
"""

from collections import Sequence
from bisect import bisect_left, bisect_right

class SortedCollection(Sequence):
    ...
    Inserting, finding, and indexing are all O(n log n) operations while
    iteration is O(n).
